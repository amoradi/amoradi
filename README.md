...
I'm a generally curious chap, fond of sound money, markets, sports and :coffee:.
...
- Architected composable, high-performance trading interfaces

**Technical Leadership**
- Led front-end teams for enterprise clients (Chevy, Manchester United, Coca-Cola)
...
- Real-time integration with traditional sportsbooks, Kalshi, and Polymarket
- Cross-platform arbitrage detection using proprietary algorithms
...
- CQRS architecture for optimized read/write operations
...
- Intra-data color customization
